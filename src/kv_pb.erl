...
-export(['enum_symbol_by_value_set_response.error'/1, 'enum_value_by_symbol_set_response.error'/1]).
-export(['enum_symbol_by_value_get_response.error'/1, 'enum_value_by_symbol_get_response.error'/1]).
...
%% enumerated types
-type 'set_response.error'() :: ok | internal.
-type 'get_response.error'() :: ok | not_found | internal.
-type 'req_envelope.msg_type'() :: 'SET_REQ' | 'SET_RESP' | 'GET_REQ' | 'GET_RESP'.
-export_type(['set_response.error'/0, 'get_response.error'/0, 'req_envelope.msg_type'/0]).
...
encode_msg_set_request(#set_request{payload = F1}, Bin, TrUserData) -> begin TrF1 = id(F1, TrUserData), e_mfield_set_request_payload(TrF1, <<Bin/binary, 10>>, TrUserData) end.

encode_msg_set_response(Msg, TrUserData) -> encode_msg_set_response(Msg, <<>>, TrUserData).


encode_msg_set_response(#set_response{result = F1}, Bin, TrUserData) -> begin TrF1 = id(F1, TrUserData), 'e_enum_set_response.error'(TrF1, <<Bin/binary, 8>>, TrUserData) end.
...
encode_msg_get_response(#get_response{result = F1, payload = F2}, Bin, TrUserData) ->
    B1 = begin TrF1 = id(F1, TrUserData), 'e_enum_get_response.error'(TrF1, <<Bin/binary, 8>>, TrUserData) end,
    if F2 == undefined -> B1;
       true -> begin TrF2 = id(F2, TrUserData), e_mfield_get_response_payload(TrF2, <<B1/binary, 18>>, TrUserData) end
    end.
...
e_mfield_set_request_payload(Msg, Bin, TrUserData) ->
    SubBin = encode_msg_data(Msg, <<>>, TrUserData),
    Bin2 = e_varint(byte_size(SubBin), Bin),
    <<Bin2/binary, SubBin/binary>>.

e_mfield_get_response_payload(Msg, Bin, TrUserData) ->
    SubBin = encode_msg_data(Msg, <<>>, TrUserData),
    Bin2 = e_varint(byte_size(SubBin), Bin),
    <<Bin2/binary, SubBin/binary>>.
...
'e_enum_set_response.error'(ok, Bin, _TrUserData) -> <<Bin/binary, 1>>;
'e_enum_set_response.error'(internal, Bin, _TrUserData) -> <<Bin/binary, 2>>;
'e_enum_set_response.error'(V, Bin, _TrUserData) -> e_varint(V, Bin).

'e_enum_get_response.error'(ok, Bin, _TrUserData) -> <<Bin/binary, 1>>;
'e_enum_get_response.error'(not_found, Bin, _TrUserData) -> <<Bin/binary, 2>>;
'e_enum_get_response.error'(internal, Bin, _TrUserData) -> <<Bin/binary, 3>>;
'e_enum_get_response.error'(V, Bin, _TrUserData) -> e_varint(V, Bin).

'e_enum_req_envelope.msg_type'('SET_REQ', Bin, _TrUserData) -> <<Bin/binary, 1>>;
'e_enum_req_envelope.msg_type'('SET_RESP', Bin, _TrUserData) -> <<Bin/binary, 2>>;
'e_enum_req_envelope.msg_type'('GET_REQ', Bin, _TrUserData) -> <<Bin/binary, 3>>;
'e_enum_req_envelope.msg_type'('GET_RESP', Bin, _TrUserData) -> <<Bin/binary, 4>>;
...
dfp_read_field_def_set_request(<<10, Rest/binary>>, Z1, Z2, F, F@_1, TrUserData) -> d_field_set_request_payload(Rest, Z1, Z2, F, F@_1, TrUserData);
dfp_read_field_def_set_request(<<>>, 0, 0, _, F@_1, _) -> #set_request{payload = F@_1};
...
dg_read_field_def_set_request(<<0:1, X:7, Rest/binary>>, N, Acc, _, F@_1, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
        10 -> d_field_set_request_payload(Rest, 0, 0, 0, F@_1, TrUserData);
        _ ->
            case Key band 7 of
...
dg_read_field_def_set_request(<<>>, 0, 0, _, F@_1, _) -> #set_request{payload = F@_1}.

d_field_set_request_payload(<<1:1, X:7, Rest/binary>>, N, Acc, F, F@_1, TrUserData) when N < 57 -> d_field_set_request_payload(Rest, N + 7, X bsl N + Acc, F, F@_1, TrUserData);
d_field_set_request_payload(<<0:1, X:7, Rest/binary>>, N, Acc, F, Prev, TrUserData) ->
...
dfp_read_field_def_set_response(<<8, Rest/binary>>, Z1, Z2, F, F@_1, TrUserData) -> d_field_set_response_result(Rest, Z1, Z2, F, F@_1, TrUserData);
dfp_read_field_def_set_response(<<>>, 0, 0, _, F@_1, _) -> #set_response{result = F@_1};
...
dg_read_field_def_set_response(<<0:1, X:7, Rest/binary>>, N, Acc, _, F@_1, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
        8 -> d_field_set_response_result(Rest, 0, 0, 0, F@_1, TrUserData);
        _ ->
            case Key band 7 of
...
dg_read_field_def_set_response(<<>>, 0, 0, _, F@_1, _) -> #set_response{result = F@_1}.

d_field_set_response_result(<<1:1, X:7, Rest/binary>>, N, Acc, F, F@_1, TrUserData) when N < 57 -> d_field_set_response_result(Rest, N + 7, X bsl N + Acc, F, F@_1, TrUserData);
d_field_set_response_result(<<0:1, X:7, Rest/binary>>, N, Acc, F, _, TrUserData) ->
    {NewFValue, RestF} = {id('d_enum_set_response.error'(begin <<Res:32/signed-native>> = <<(X bsl N + Acc):32/unsigned-native>>, id(Res, TrUserData) end), TrUserData), Rest},
...
dfp_read_field_def_get_response(<<8, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, TrUserData) -> d_field_get_response_result(Rest, Z1, Z2, F, F@_1, F@_2, TrUserData);
dfp_read_field_def_get_response(<<18, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, TrUserData) -> d_field_get_response_payload(Rest, Z1, Z2, F, F@_1, F@_2, TrUserData);
dfp_read_field_def_get_response(<<>>, 0, 0, _, F@_1, F@_2, _) -> #get_response{result = F@_1, payload = F@_2};
...
dg_read_field_def_get_response(<<0:1, X:7, Rest/binary>>, N, Acc, _, F@_1, F@_2, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
        8 -> d_field_get_response_result(Rest, 0, 0, 0, F@_1, F@_2, TrUserData);
        18 -> d_field_get_response_payload(Rest, 0, 0, 0, F@_1, F@_2, TrUserData);
        _ ->
            case Key band 7 of
...
dg_read_field_def_get_response(<<>>, 0, 0, _, F@_1, F@_2, _) -> #get_response{result = F@_1, payload = F@_2}.

d_field_get_response_result(<<1:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, TrUserData) when N < 57 -> d_field_get_response_result(Rest, N + 7, X bsl N + Acc, F, F@_1, F@_2, TrUserData);
d_field_get_response_result(<<0:1, X:7, Rest/binary>>, N, Acc, F, _, F@_2, TrUserData) ->
    {NewFValue, RestF} = {id('d_enum_get_response.error'(begin <<Res:32/signed-native>> = <<(X bsl N + Acc):32/unsigned-native>>, id(Res, TrUserData) end), TrUserData), Rest},
    dfp_read_field_def_get_response(RestF, 0, 0, F, NewFValue, F@_2, TrUserData).

d_field_get_response_payload(<<1:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, TrUserData) when N < 57 -> d_field_get_response_payload(Rest, N + 7, X bsl N + Acc, F, F@_1, F@_2, TrUserData);
d_field_get_response_payload(<<0:1, X:7, Rest/binary>>, N, Acc, F, F@_1, Prev, TrUserData) ->
    {NewFValue, RestF} = begin Len = X bsl N + Acc, <<Bs:Len/binary, Rest2/binary>> = Rest, {id(decode_msg_data(Bs, TrUserData), TrUserData), Rest2} end,
...
'd_enum_set_response.error'(1) -> ok;
'd_enum_set_response.error'(2) -> internal;
'd_enum_set_response.error'(V) -> V.

'd_enum_get_response.error'(1) -> ok;
'd_enum_get_response.error'(2) -> not_found;
'd_enum_get_response.error'(3) -> internal;
'd_enum_get_response.error'(V) -> V.

'd_enum_req_envelope.msg_type'(1) -> 'SET_REQ';
'd_enum_req_envelope.msg_type'(2) -> 'SET_RESP';
'd_enum_req_envelope.msg_type'(3) -> 'GET_REQ';
'd_enum_req_envelope.msg_type'(4) -> 'GET_RESP';
...
merge_msg_set_request(#set_request{payload = PFpayload}, #set_request{payload = NFpayload}, TrUserData) -> #set_request{payload = merge_msg_data(PFpayload, NFpayload, TrUserData)}.

-compile({nowarn_unused_function,merge_msg_set_response/3}).
merge_msg_set_response(#set_response{}, #set_response{result = NFresult}, _) -> #set_response{result = NFresult}.
...
merge_msg_get_response(#get_response{payload = PFpayload}, #get_response{result = NFresult, payload = NFpayload}, TrUserData) ->
    #get_response{result = NFresult,
                  payload =
                      if PFpayload /= undefined, NFpayload /= undefined -> merge_msg_data(PFpayload, NFpayload, TrUserData);
...
v_msg_set_request(#set_request{payload = F1}, Path, TrUserData) ->
    v_submsg_data(F1, [payload | Path], TrUserData),
    ok;
...
v_msg_set_response(#set_response{result = F1}, Path, TrUserData) ->
    'v_enum_set_response.error'(F1, [result | Path], TrUserData),
    ok;
...
v_msg_get_response(#get_response{result = F1, payload = F2}, Path, TrUserData) ->
    'v_enum_get_response.error'(F1, [result | Path], TrUserData),
    if F2 == undefined -> ok;
       true -> v_submsg_data(F2, [payload | Path], TrUserData)
    end,
    ok;
...
-compile({nowarn_unused_function,'v_enum_set_response.error'/3}).
-dialyzer({nowarn_function,'v_enum_set_response.error'/3}).
'v_enum_set_response.error'(ok, _Path, _TrUserData) -> ok;
'v_enum_set_response.error'(internal, _Path, _TrUserData) -> ok;
'v_enum_set_response.error'(V, _Path, _TrUserData) when -2147483648 =< V, V =< 2147483647, is_integer(V) -> ok;
'v_enum_set_response.error'(X, Path, _TrUserData) -> mk_type_error({invalid_enum, 'set_response.error'}, X, Path).

-compile({nowarn_unused_function,'v_enum_get_response.error'/3}).
-dialyzer({nowarn_function,'v_enum_get_response.error'/3}).
'v_enum_get_response.error'(ok, _Path, _TrUserData) -> ok;
'v_enum_get_response.error'(not_found, _Path, _TrUserData) -> ok;
'v_enum_get_response.error'(internal, _Path, _TrUserData) -> ok;
'v_enum_get_response.error'(V, _Path, _TrUserData) when -2147483648 =< V, V =< 2147483647, is_integer(V) -> ok;
'v_enum_get_response.error'(X, Path, _TrUserData) -> mk_type_error({invalid_enum, 'get_response.error'}, X, Path).

-compile({nowarn_unused_function,'v_enum_req_envelope.msg_type'/3}).
-dialyzer({nowarn_function,'v_enum_req_envelope.msg_type'/3}).
'v_enum_req_envelope.msg_type'('SET_REQ', _Path, _TrUserData) -> ok;
'v_enum_req_envelope.msg_type'('SET_RESP', _Path, _TrUserData) -> ok;
'v_enum_req_envelope.msg_type'('GET_REQ', _Path, _TrUserData) -> ok;
'v_enum_req_envelope.msg_type'('GET_RESP', _Path, _TrUserData) -> ok;
...
get_msg_defs() ->
    [{{enum, 'set_response.error'}, [{ok, 1}, {internal, 2}]},
     {{enum, 'get_response.error'}, [{ok, 1}, {not_found, 2}, {internal, 3}]},
     {{enum, 'req_envelope.msg_type'}, [{'SET_REQ', 1}, {'SET_RESP', 2}, {'GET_REQ', 3}, {'GET_RESP', 4}]},
     ...
     {{msg, set_request}, [#field{name = payload, fnum = 1, rnum = 2, type = {msg, data}, occurrence = required, opts = []}]},
     {{msg, set_response}, [#field{name = result, fnum = 1, rnum = 2, type = {enum, 'set_response.error'}, occurrence = required, opts = []}]},
     {{msg, get_request}, [#field{name = key, fnum = 1, rnum = 2, type = string, occurrence = required, opts = []}]},
     {{msg, get_response}, [#field{name = result, fnum = 1, rnum = 2, type = {enum, 'get_response.error'}, occurrence = required, opts = []}, #field{name = payload, fnum = 2, rnum = 3, type = {msg, data}, occurrence = optional, opts = []}]},
     {{msg, req_envelope},
...
get_enum_names() -> ['set_response.error', 'get_response.error', 'req_envelope.msg_type'].
...
find_msg_def(set_request) -> [#field{name = payload, fnum = 1, rnum = 2, type = {msg, data}, occurrence = required, opts = []}];
find_msg_def(set_response) -> [#field{name = result, fnum = 1, rnum = 2, type = {enum, 'set_response.error'}, occurrence = required, opts = []}];
find_msg_def(get_request) -> [#field{name = key, fnum = 1, rnum = 2, type = string, occurrence = required, opts = []}];
find_msg_def(get_response) -> [#field{name = result, fnum = 1, rnum = 2, type = {enum, 'get_response.error'}, occurrence = required, opts = []}, #field{name = payload, fnum = 2, rnum = 3, type = {msg, data}, occurrence = optional, opts = []}];
...
find_enum_def('set_response.error') -> [{ok, 1}, {internal, 2}];
find_enum_def('get_response.error') -> [{ok, 1}, {not_found, 2}, {internal, 3}];
find_enum_def('req_envelope.msg_type') -> [{'SET_REQ', 1}, {'SET_RESP', 2}, {'GET_REQ', 3}, {'GET_RESP', 4}];
find_enum_def(_) -> error.


enum_symbol_by_value('set_response.error', Value) -> 'enum_symbol_by_value_set_response.error'(Value);
enum_symbol_by_value('get_response.error', Value) -> 'enum_symbol_by_value_get_response.error'(Value);
enum_symbol_by_value('req_envelope.msg_type', Value) -> 'enum_symbol_by_value_req_envelope.msg_type'(Value).


enum_value_by_symbol('set_response.error', Sym) -> 'enum_value_by_symbol_set_response.error'(Sym);
enum_value_by_symbol('get_response.error', Sym) -> 'enum_value_by_symbol_get_response.error'(Sym);
enum_value_by_symbol('req_envelope.msg_type', Sym) -> 'enum_value_by_symbol_req_envelope.msg_type'(Sym).


'enum_symbol_by_value_set_response.error'(1) -> ok;
'enum_symbol_by_value_set_response.error'(2) -> internal.


'enum_value_by_symbol_set_response.error'(ok) -> 1;
'enum_value_by_symbol_set_response.error'(internal) -> 2.

'enum_symbol_by_value_get_response.error'(1) -> ok;
'enum_symbol_by_value_get_response.error'(2) -> not_found;
'enum_symbol_by_value_get_response.error'(3) -> internal.


'enum_value_by_symbol_get_response.error'(ok) -> 1;
'enum_value_by_symbol_get_response.error'(not_found) -> 2;
'enum_value_by_symbol_get_response.error'(internal) -> 3.

'enum_symbol_by_value_req_envelope.msg_type'(1) -> 'SET_REQ';
'enum_symbol_by_value_req_envelope.msg_type'(2) -> 'SET_RESP';
'enum_symbol_by_value_req_envelope.msg_type'(3) -> 'GET_REQ';
'enum_symbol_by_value_req_envelope.msg_type'(4) -> 'GET_RESP'.


'enum_value_by_symbol_req_envelope.msg_type'('SET_REQ') -> 1;
'enum_value_by_symbol_req_envelope.msg_type'('SET_RESP') -> 2;
'enum_value_by_symbol_req_envelope.msg_type'('GET_REQ') -> 3;
'enum_value_by_symbol_req_envelope.msg_type'('GET_RESP') -> 4.
...
fqbin_to_msg_name(<<"kv.data">>) -> data;
fqbin_to_msg_name(<<"kv.set_request">>) -> set_request;
fqbin_to_msg_name(<<"kv.set_response">>) -> set_response;
fqbin_to_msg_name(<<"kv.get_request">>) -> get_request;
fqbin_to_msg_name(<<"kv.get_response">>) -> get_response;
fqbin_to_msg_name(<<"kv.req_envelope">>) -> req_envelope;
fqbin_to_msg_name(E) -> error({gpb_error, {badmsg, E}}).


msg_name_to_fqbin(data) -> <<"kv.data">>;
msg_name_to_fqbin(set_request) -> <<"kv.set_request">>;
msg_name_to_fqbin(set_response) -> <<"kv.set_response">>;
msg_name_to_fqbin(get_request) -> <<"kv.get_request">>;
msg_name_to_fqbin(get_response) -> <<"kv.get_response">>;
msg_name_to_fqbin(req_envelope) -> <<"kv.req_envelope">>;
msg_name_to_fqbin(E) -> error({gpb_error, {badmsg, E}}).


fqbin_to_enum_name(<<"kv.set_response.error">>) -> 'set_response.error';
fqbin_to_enum_name(<<"kv.get_response.error">>) -> 'get_response.error';
fqbin_to_enum_name(<<"kv.req_envelope.msg_type">>) -> 'req_envelope.msg_type';
fqbin_to_enum_name(E) -> error({gpb_error, {badenum, E}}).


enum_name_to_fqbin('set_response.error') -> <<"kv.set_response.error">>;
enum_name_to_fqbin('get_response.error') -> <<"kv.get_response.error">>;
enum_name_to_fqbin('req_envelope.msg_type') -> <<"kv.req_envelope.msg_type">>;
...
get_enum_containment("kv") -> ['get_response.error', 'req_envelope.msg_type', 'set_response.error'];
get_enum_containment(P) -> error({gpb_error, {badproto, P}}).


get_proto_by_msg_name_as_fqbin(<<"kv.data">>) -> "kv";
get_proto_by_msg_name_as_fqbin(<<"kv.set_request">>) -> "kv";
get_proto_by_msg_name_as_fqbin(<<"kv.get_request">>) -> "kv";
get_proto_by_msg_name_as_fqbin(<<"kv.set_response">>) -> "kv";
get_proto_by_msg_name_as_fqbin(<<"kv.req_envelope">>) -> "kv";
get_proto_by_msg_name_as_fqbin(<<"kv.get_response">>) -> "kv";
...
get_proto_by_enum_name_as_fqbin(<<"kv.set_response.error">>) -> "kv";
get_proto_by_enum_name_as_fqbin(<<"kv.get_response.error">>) -> "kv";
get_proto_by_enum_name_as_fqbin(<<"kv.req_envelope.msg_type">>) -> "kv";
